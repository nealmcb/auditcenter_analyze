...
- **County Ballot Card Count:** 1,729
- **Diluted Margin:** 0.559283
  - Calculated as: min_margin / county_ballot_card_count = 967 / 1729
- **Sample Size:** 15
- **Discrepancies Found:** 0
- **Risk Level (Opportunistic - all available samples):** 0.907%
...
### Targeted Contest Verification

**Risk calculation using ONLY this contest's samples:**

- **Sample Size (n):** 15
- **Diluted Margin:** 0.559283
- **Gamma:** 1.03905
- **Discrepancies:** o1=0, o2=0, u1=0, u2=0
