...
def generate_random_numbers_verbose(seed: str, count: int, domain_size: int, show_details: int = 5) -> List[int]:
    """
...
def main():
    ...
    random_selections = generate_random_numbers_verbose(SEED, SAMPLE_SIZE, BALLOT_CARD_COUNT, show_details=5)
